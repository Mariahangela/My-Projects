            ...
            return Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Text(
                    "Questions ${index + 1} / ${others.length}",
                    style: TextStyle(
                ...
                for (int i = 0; i < others[index].answers!.length; i++)
                  Container(
                    width: double.infinity,
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      others[index].answers!.entries.toList()[i].value
                          ? isTrue
                          : isWrong
                          : secondColor,
                      ...
                      child: Text(others[index].answers!.keys.toList()[i],
                        style: TextStyle(
                          color: Colors.white,
                          fontSize:15.0,
                        ),
