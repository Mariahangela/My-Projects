          ...
          itemBuilder: (context, index) {
            return Column(
              ...
              children: [
                ...
                for (int i = 0; i < uno[index].sagot!.length; i++)
                  Container(
                    width: double.infinity,
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      uno[index].sagot!.entries.toList()[i].value
                          ? isTrue
                          : isWrong
                          : secondColor,
                      ...
                      child: Text(uno[index].sagot!.keys.toList()[i],
                        style: TextStyle(
                          color: Colors.white,
                          fontSize:15.0,
                        ),
